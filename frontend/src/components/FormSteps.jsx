...
export function Step0Agency({ data, setData }) {
  ...
  return (
    <div className="step-panel active">
      <div className="card">
        <div className="card-title">Agency Details</div>
        <div className="fg c2">
  ...
  return (
    <div className="step-panel active">
      <div className="card">
        ...
        <div className="fg c2">
          <div className="f"><label>Full Name <span className="r">*</span></label><input type="text" value={data.contact_name} onChange={e=>setData({...data, contact_name:e.target.value})} /></div>
        ...
        <div className="fg c2 mt">
          <div className="f"><label>Mobile <span className="r">*</span></label><input type="tel" value={data.contact_mobile} onChange={e=>setData({...data, contact_mobile:e.target.value})} placeholder="+91" /></div>
      ...
      <div className="card">
        <div className="card-title">Office Address</div>
        <div className="f">
        ...
        <div className="fg c2 mt">
          ...
          <div className="f"><label>Postal / PIN Code</label><input type="text" value={data.pin} onChange={e=>setData({...data, pin:e.target.value})} /></div>
        </div>
      </div>
    </div>
  );
...
export function Step3Partnership({ data, setData }) {
  return (
    <div className="step-panel active">
      <div className="card">
        <div className="card-title">Partnership Expectations</div>
        <div className="fg c2">
...
export function Step4Banking({ data, setData }) {
  const toggleDoc = (field) => setData({...data, [field]: !data[field]});

  return (
    <div className="step-panel active">
      <div className="card">
        <div className="card-title">Banking Details</div>
      ...
      <div className="card">
        <div className="card-title">Documents Required</div>
        <p style={{fontSize:'13px',color:'var(--text-muted)',marginBottom:'14px'}}>Confirm you will attach self-attested copies of the following:</p>
        <div className="doc-grid">
          <div className={`doc-item ${data.docs_gst?'on':''}`} onClick={()=>toggleDoc('docs_gst')}>
            <div className="doc-chk-box"><svg className="doc-chk-icon" viewBox="0 0 12 12"><path d="M2,6 L5,9 L10,3"/></svg></div>
            <div className="doc-label">GST Registration Certificate</div>
          </div>
          <div className={`doc-item ${data.docs_pan?'on':''}`} onClick={()=>toggleDoc('docs_pan')}>
            <div className="doc-chk-box"><svg className="doc-chk-icon" viewBox="0 0 12 12"><path d="M2,6 L5,9 L10,3"/></svg></div>
            <div className="doc-label">PAN Card</div>
          </div>
          <div className={`doc-item ${data.docs_company?'on':''}`} onClick={()=>toggleDoc('docs_company')}>
            <div className="doc-chk-box"><svg className="doc-chk-icon" viewBox="0 0 12 12"><path d="M2,6 L5,9 L10,3"/></svg></div>
            <div className="doc-label">Company Registration</div>
          </div>
          <div className={`doc-item ${data.docs_cheque?'on':''}`} onClick={()=>toggleDoc('docs_cheque')}>
            <div className="doc-chk-box"><svg className="doc-chk-icon" viewBox="0 0 12 12"><path d="M2,6 L5,9 L10,3"/></svg></div>
            <div className="doc-label">Cancelled Cheque</div>
          </div>
        </div>
      </div>
    </div>
  ...
  return (
    <div className="step-panel active">
      <div className="tc-dark">
        <div className="tc-dark-title">Terms & Conditions</div>
      ...
      <div className="card">
        ...
        <div className={`agree-row ${data.agreed?'on':''}`} onClick={()=>setData({...data,agreed:!data.agreed})}>
          ...
          <div className="agree-label">I confirm all information provided is true and accurate. I agree to comply with all policies and guidelines of this resort.</div>
        </div>
        <div className="sig-row">
          ...
          <div className="sig-f"><label>Designation <span className="r" style={{color:'var(--accent)'}}>*</span></label><input type="text" value={data.signatory_designation} onChange={e=>setData({...data, signatory_designation:e.target.value})} /></div>
        </div>
...
export function Step6Review({ data }) {
  return (
    <div className="step-panel active">
      ...
      <div className="review-block">
        <div className="review-block-hd">Banking & Declaration</div>
        <table className="review-tbl">
          <tbody>
            ...
            <tr><td>Signatory</td><td>{data.signatory_name || '—'}</td></tr>
